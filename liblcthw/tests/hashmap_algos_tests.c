...
struct tagbstring test1 = bsStatic("value1");
struct tagbstring test2 = bsStatic("value2");
struct tagbstring test3 = bsStatic("value3");
...
char* test_distribution()
{
    ...
    mu_assert (get_keys(keys, NUM_KEYS) == 0,
